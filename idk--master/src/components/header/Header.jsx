    ...
    return (
        <div className="header">
          <div className={type === "list" ? "headerContainer listMode" : "headerContainer"}>
            ...
            <h2 className="headerDesc">Search deals on hotels, homes, and much more....</h2>
                    ...
                    <span onClick={()=>setOpenOptions(!openOptions)} className="headerSearchText">{`${options.adult} adult . ${options.children} children . ${options.room} room `}</span>
                     {openOptions && <div className="options">
                      <div className="optionItems">
                        ...
                        className="optionsCounterButton " onClick={()=>handleOption("adult","d")}>-</button>
                       ...
                       <div className="optionItems">
                        ...
                        className="optionsCounterButton" onClick={()=>handleOption("children","d")}>-</button>
                       ...
                       <div className="optionItems">
                        ...
                        className="optionsCounterButton" onClick={()=>handleOption("room","d")}>-</button>
